                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                    <tr>
                        <td style="background:linear-gradient(135deg,#0A1F44 0%,#1a3a6e 100%);padding:32px 40px;text-align:center;">
                            ...
                            <p style="margin:8px 0 0;color:rgba(255,255,255,0.7);font-size:14px;">Обновление пароля</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 24px;color:#4a5568;font-size:15px;line-height:1.6;">
                                Ваш пароль в системе VisaBor был обновлён руководителем агентства <strong>{{ $agencyName }}</strong>.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" style="background:#fefce8;border-radius:12px;border:1px solid #fde68a;margin-bottom:24px;">
                                <tr>
                                    <td style="padding:20px;">
                                        <p style="margin:0 0 12px;font-size:13px;color:#92400e;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">Новые данные для входа</p>
                                        <p style="margin:0 0 6px;font-size:15px;color:#0A1F44;"><strong>Email:</strong> {{ $userEmail }}</p>
                                        <p style="margin:0;font-size:15px;color:#0A1F44;"><strong>Новый пароль:</strong> {{ $password }}</p>
                                    </td>
                                </tr>
                            </table>
