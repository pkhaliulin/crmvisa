...
class TestAgenciesSeeder extends Seeder
{
    ...
    private array $clients = [
        [
            ['name' => 'Камол Мирзаев',     'phone' => '+998901111001', 'nationality' => 'UZ', 'country' => 'DE', 'visa' => 'tourist'],
            ['name' => 'Дилноза Ташматова', 'phone' => '+998901111002', 'nationality' => 'UZ', 'country' => 'FR', 'visa' => 'student'],
            ['name' => 'Жасур Юсупов',      'phone' => '+998901111003', 'nationality' => 'UZ', 'country' => 'IT', 'visa' => 'tourist'],
            ['name' => 'Умида Мансурова',   'phone' => '+998901111004', 'nationality' => 'UZ', 'country' => 'DE', 'visa' => 'work'],
            ['name' => 'Лазиз Халиков',     'phone' => '+998901111005', 'nationality' => 'UZ', 'country' => 'FR', 'visa' => 'business'],
        ],
        [
            ['name' => 'Азиз Рустамов',     'phone' => '+998901112001', 'nationality' => 'UZ', 'country' => 'GB', 'visa' => 'tourist'],
            ['name' => 'Насиба Усманова',   'phone' => '+998901112002', 'nationality' => 'UZ', 'country' => 'DE', 'visa' => 'student'],
            ['name' => 'Фирдавс Бекмуродов','phone' => '+998901112003', 'nationality' => 'UZ', 'country' => 'TR', 'visa' => 'tourist'],
            ['name' => 'Шарифа Мухаммадова','phone' => '+998901112004', 'nationality' => 'UZ', 'country' => 'GB', 'visa' => 'work'],
            ['name' => 'Дониёр Эшматов',    'phone' => '+998901112005', 'nationality' => 'UZ', 'country' => 'TR', 'visa' => 'business'],
        ],
        [
            ['name' => 'Ойбек Сатторов',    'phone' => '+998901113001', 'nationality' => 'UZ', 'country' => 'AE', 'visa' => 'tourist'],
            ['name' => 'Зарнигор Алиева',   'phone' => '+998901113002', 'nationality' => 'UZ', 'country' => 'TR', 'visa' => 'student'],
            ['name' => 'Рустам Норматов',   'phone' => '+998901113003', 'nationality' => 'UZ', 'country' => 'CN', 'visa' => 'business'],
            ['name' => 'Хилола Турдиева',   'phone' => '+998901113004', 'nationality' => 'UZ', 'country' => 'AE', 'visa' => 'work'],
            ['name' => 'Сиддиқ Мирзаев',   'phone' => '+998901113005', 'nationality' => 'UZ', 'country' => 'TR', 'visa' => 'tourist'],
        ],
        [
            ['name' => 'Комилжон Холиқов',  'phone' => '+998901114001', 'nationality' => 'UZ', 'country' => 'US', 'visa' => 'tourist'],
            ['name' => 'Матлуба Кенжаева',  'phone' => '+998901114002', 'nationality' => 'UZ', 'country' => 'GB', 'visa' => 'student'],
            ['name' => 'Беҳзод Исмоилов',   'phone' => '+998901114003', 'nationality' => 'UZ', 'country' => 'DE', 'visa' => 'work'],
            ['name' => 'Гавҳар Тоирова',    'phone' => '+998901114004', 'nationality' => 'UZ', 'country' => 'US', 'visa' => 'business'],
            ['name' => 'Шерзод Ортиқов',    'phone' => '+998901114005', 'nationality' => 'UZ', 'country' => 'GB', 'visa' => 'tourist'],
        ],
        [
            ['name' => 'Акбар Норқулов',    'phone' => '+998901115001', 'nationality' => 'UZ', 'country' => 'TR', 'visa' => 'tourist'],
            ['name' => 'Муаззам Юлдашева',  'phone' => '+998901115002', 'nationality' => 'UZ', 'country' => 'AE', 'visa' => 'work'],
            ['name' => 'Ихтиёр Очилов',     'phone' => '+998901115003', 'nationality' => 'UZ', 'country' => 'RU', 'visa' => 'business'],
            ['name' => 'Шаҳноза Холдорова', 'phone' => '+998901115004', 'nationality' => 'UZ', 'country' => 'TR', 'visa' => 'student'],
            ['name' => 'Мансур Тўхтаев',    'phone' => '+998901115005', 'nationality' => 'UZ', 'country' => 'AE', 'visa' => 'tourist'],
        ],
    ];
            ...
            foreach ($this->clients[$ai] as $ci => $clientData) {
                ...
                DB::table('clients')->upsert([
                    [
                        ...
                        'source'      => ['direct', 'referral', 'website', 'social', 'marketplace'][($ci + $ai) % 5],
