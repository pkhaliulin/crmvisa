...
class ContractService
{
    ...
    public function getContractData(VisaCase $case): array
    {
        ...
        return [
            ...
            'agency'           => [
                'name'         => $case->agency->legal_name ?: $case->agency->name ?? '',
                'legal_form'   => $case->agency->legal_form ?? '',
                'inn'          => $case->agency->inn ?? '',
                'address'      => $case->agency->legal_address ?: $case->agency->address ?? '',
                'phone'        => $case->agency->phone ?? '',
                'email'        => $case->agency->email ?? '',
                'bank_account' => $case->agency->bank_account ?? '',
                'bank_name'    => $case->agency->bank_name ?? '',
                'bank_mfo'     => $case->agency->bank_mfo ?? '',
                'director'     => $case->agency->director_name ?? '',
                'director_basis' => $case->agency->director_basis ?? '',
            ],
            'client'           => [
